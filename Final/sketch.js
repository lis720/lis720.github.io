...
function preload() {
  ...
  positions = sceneData = loadJSON('positions.json');
...
function gameDraw(){
  ...
  spr.velocity.x = (mouseX-spr.position.x)*0.03
    // (mouseX-spr.position.x)*0.1;
  spr.velocity.y = (mouseY-spr.position.y)*0.03
