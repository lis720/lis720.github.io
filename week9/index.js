...
// // fetch('https://api.nytimes.com/svc/books/v3/lists/best-sellers/history.json&api-key=4ff915ebe1fa490587e91bd40485bb68' + nytimesKey, {
// //     method: 'get',
// //   })
...
// url += '?' + $.param({
//   'api-key': "4ff915ebe1fa490587e91bd40485bb68"
// });
// $.ajax({
//   url: url,
//   method: 'GET',
...
//   fetch('https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn + "&key=AIzaSyApZqnvxyI0rou-Lm_iL9Wrrf1AVLTem3A" + googleBooksKey, {
//     method: 'get'
//   })
//   .then(response => { return response.json(); })
//   .then(data => {
...
var url = "https://api.nytimes.com/svc/books/v3/lists.json?list-name=hardcover-fiction&api-key=6ad84e249d054efeaefe1abb8f89df5b";
$.ajax({
  url: url,
  method: 'GET',
}).done(function(result) {
  console.log(result);
  updateBestSellers(result);
...
function updateCover(id, isbn) {
  fetch('https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn + "&key=AIzaSyBK87y2qAkKPYkUoe10jDhLhFAKHnyWzhc", {
    method: 'get'
  })
  .then(response => { return response.json(); })
  .then(data => {
